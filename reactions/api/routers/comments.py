...
from reactions.api.models import CommentOut,CommentIn
from reactions.api.db_manager import comments as db_comments
...
@comments.get('/comments-by-videos', response_model=List[CommentOut],summary="All Comments by videos")
...
@comments.put('/{id}', response_model=CommentOut,summary="update comments", status_code=201)
