...
from reactions.api.models import TokenSchema
from fastapi import APIRouter,Depends
import requests

users=APIRouter()

@users.post('/token', summary="Create access and refresh tokens for user", response_model=TokenSchema, include_in_schema=False)
